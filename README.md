...
- サマリーファイルを追加しました. 質量順に糖鎖をならべ同じ理論質量をもつ同定された構造は同じセルに出力しました. さらに帰属した糖鎖と残基1つ違いの糖鎖をリスト化しそのＩＤも付しました. ただし化学的な検討は行っておらず単純に残基1つ違う糖鎖を抽出しています. この検討に含まれる残基はHex, HexNAc, Fuc, NeuAc, NeuGc, 3-8NeuAc, 6NeuAC, 3-8NeuGc, 6NeuGcの9残基種になります.
