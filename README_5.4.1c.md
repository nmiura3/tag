...
- クラスタリングのアルゴリズムについて3番の方法を変更しました. 通常のように糖鎖を帰属したのちに内部標準がどのクラスターにいるかを確認するだけにしました. これは, スペクトルの様子やその他の原因で, 内部標準が正解ではないクラスターに含まれる可能性があるためこのようにしました.
...
| D1 | m/zとΔm/zによる分布をクラスター分析しどのクラスターを取得するかについてのフラグ. 内容は上述(5.4.1cでは９番をデフォルトとした)|
<br>
